...
[![Version](https://img.shields.io/badge/version-0.0.3-555555.svg?logo=changelog&logoColor=white&style=flat)](CHANGELOG.md)
...
- версия **0.0.3** · [CHANGELOG](CHANGELOG.md)

**Следующий шаг:** Phase 1 / stage 1.1 — Root + scaling + background (первый реальный greeter-код).
